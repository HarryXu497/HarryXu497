...
[![My Skills](https://skillicons.dev/icons?i=java,py,cpp,mysql,js,ts,html,css,svelte,react,nextjs,vite,angular,nodejs,tailwind,sass,dart,kotlin,flutter,arduino,git,github,figma,firebase,vscode,pycharm,idea,androidstudio,xcode)](https://skillicons.dev)
